...
const resources = {
  en: {
    translation: {
      ...
      prCreate: 'Create Product',
      adminModalProductName: 'Name',
      adminModalProductDesc: 'Description',
      adminModalProductPrice: 'Price',
      adminModalProductRestaurants: 'Restaurants',
      adminModalCancel: 'Cancel',
      adminModalAddProduct: 'Add Product',
      adminModalUploadImage: 'Upload Image',
      adminModalProductInformation: 'Add your Product information',
      adminModalSelectChoose: 'Choose',
      ofAdd: 'Add Offer',
      ofCreate: 'Create Offer',
      cateCreate: 'Create Category',
      resCreate: 'Create Restaurant',
      adminModalOfferInformation: 'Add your Offer information',
      adminModalCategoryInformation: 'Add your Category information',
      cateAdd: 'Add Category',
      resAdd: 'Add Restaurant',
      adminModalRestaurantInformation: 'Add your Restaurant information',
      adminRestaurantDeliveryMin: 'Delivery min',
  ...
  az: {
    translation: {
      ...
      addOffer: '+ Təklif əlavə et',
      addRestaurant: '+ Restoran əlavə et',
      addCategory: '+ Kateqoriya əlavə et',
      adminOrder1: 'Müştəri ID',
      prCreate: 'Məhsul əlavə et',
      adminModalProductName: 'Ad',
      adminModalProductDesc: 'Ümumi Təsviri',
      adminModalProductPrice: 'Qiymət',
      adminModalProductRestaurants: 'Restoranlar',
      adminModalCancel: 'Ləğv etmək',
      adminModalAddProduct: 'Məhsul əlavə etmək',
      adminModalUploadImage: 'Şəkil əlavə et',
      adminModalProductInformation: 'Məhsul məlumatınızı əlavə edin',
      adminModalSelectChoose: 'Seç',
      ofAdd: 'Təklif əlavə et',
      ofCreate: 'Təklifi yarat',
      cateCreate: 'Kateqoriyanı yarat',
      resCreate: 'Restoran yarat',
      adminModalOfferInformation: 'Təklif məlumatınızı əlavə edin',
      adminModalCategoryInformation: 'Kateqoriya məlumatınızı əlavə edin',
      cateAdd: 'Kateqoriya əlavə edin',
      resAdd: 'Restoran əlavə edin',
      adminModalRestaurantInformation: 'Restoran məlumatınızı əlavə edin',
      adminRestaurantDeliveryMin: 'Çatdırılma vaxtı',
