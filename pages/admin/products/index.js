...
import { getRestaurantById, getRestaurants } from '../../../shared/services/axios'
...
const Products = () => {
  ...
  return (
    <AdminLayout>
      <Subheading text={"Products"} type={"Restaurant"} state={restaurants} handleClick={getAllRestaurants} handleSearchByType={getProductsByRestaurant} />
